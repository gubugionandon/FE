...
export const TypographyShowcase: Story = {
    render: () => (
        <div className="space-y-12">
            ...
            {/* Headline 계층 */}
            <div>
                <h2 className="text-headline-2xl-semibold mb-6 text-gray-600">Headline</h2>
                <div className="space-y-6">
                    <div>
                        <h3 className="text-body-md-semibold mb-3 text-gray-500">3xl (24px)</h3>
                        <div className="space-y-3">
                            <div className="flex items-center gap-4">
                                <div className="w-32 text-sm text-gray-500">headline-3xl-regular</div>
                                <Typography variant="headline-3xl-regular">Ag regular</Typography>
                                <div className="text-xs text-gray-400">24px / 400</div>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="w-32 text-sm text-gray-500">headline-3xl-medium</div>
                                <Typography variant="headline-3xl-medium">Ag medium</Typography>
                                <div className="text-xs text-gray-400">24px / 500</div>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="w-32 text-sm text-gray-500">headline-3xl-semibold</div>
                                <Typography variant="headline-3xl-semibold">Ag semibold</Typography>
                    ...
                    <div>
                        <h3 className="text-body-md-semibold mb-3 text-gray-500">2xl (22px)</h3>
                        <div className="space-y-3">
                            <div className="flex items-center gap-4">
                                <div className="w-32 text-sm text-gray-500">headline-2xl-regular</div>
                                <Typography variant="headline-2xl-regular">Ag regular</Typography>
                                <div className="text-xs text-gray-400">22px / 400</div>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="w-32 text-sm text-gray-500">headline-2xl-medium</div>
                                <Typography variant="headline-2xl-medium">Ag medium</Typography>
                                <div className="text-xs text-gray-400">22px / 500</div>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="w-32 text-sm text-gray-500">headline-2xl-semibold</div>
                                <Typography variant="headline-2xl-semibold">Ag semibold</Typography>
            ...
            <div>
                ...
                <div className="space-y-6">
                    <div>
                        <h3 className="text-body-md-semibold mb-3 text-gray-500">xl (20px)</h3>
                        <div className="space-y-3">
                            <div className="flex items-center gap-4">
                                <div className="w-32 text-sm text-gray-500">body-xl-regular</div>
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-32 text-sm text-gray-500">body-xl-semibold</div>
                    ...
                    <div>
                        <h3 className="text-body-md-semibold mb-3 text-gray-500">lg (18px)</h3>
                        <div className="space-y-3">
                            <div className="flex items-center gap-4">
                                <div className="w-32 text-sm text-gray-500">body-lg-regular</div>
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-32 text-sm text-gray-500">body-lg-semibold</div>
                    ...
                    <div>
                        <h3 className="text-body-md-semibold mb-3 text-gray-500">md (16px)</h3>
                        <div className="space-y-3">
                            <div className="flex items-center gap-4">
                                <div className="w-32 text-sm text-gray-500">body-md-regular</div>
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-32 text-sm text-gray-500">body-md-semibold</div>
            ...
            {/* Caption 계층 */}
            <div>
                <h2 className="text-headline-2xl-semibold mb-6 text-gray-600">Caption</h2>
                <div className="space-y-3">
                    <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="w-32 text-sm text-gray-500">caption-sm-semibold</div>
